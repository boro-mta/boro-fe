...
import { selectPicture, selectUserName, selectGuid, updateUser } from "../../features/UserSlice"
            ...
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                        ...
                        >
                            {pages.map((page) => (
                                <MenuItem key={page} onClick={() => handleMenuButtonClick(page)}>
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        ...
                        >
                            {settings.map((setting) => (
                                <MenuItem key={setting} onClick={() => handleSettingButtonClick(setting)}>
