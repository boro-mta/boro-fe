...
const LeaderBoard = () => {
    ...
    const fromUserStatisticsToLeaderBoardRows = async (serverTopTenLeaders: IUserStatistics[]) => {
        ...
        const leadersByPlace: ILeaderBoardRow[] = [...leaderBoardRowsToReturn].sort((a, b) => {
    ...
    useEffect(() => {
        const getLeaderBoardRows = async () => {
            ...
            if (serverTopTenLeaders.length > 0) {
                const serverTopTenLeadersAsLeaderBoardRows = await fromUserStatisticsToLeaderBoardRows(serverTopTenLeaders);
